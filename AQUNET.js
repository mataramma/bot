const net = require("net");
 ...
 if (process.argv.length < 7){
	 console.log(`
  Usage:[TARGET] [TIME] [REQUEST] [THREAD] [PROXY FILE]`); 
	 process.exit();}
 const headers = {};
 ...
 const cplist = [ // Captcha Solve by @A18 10-04-2023
 ...
 class NetSocket {
  ...
  HTTP(options, callback) {
     const parsedAddr = options.address.split(":"); // Socket Connection Fixed by @A18 27-03-2023
     ...
     connection.on("data", chunk => { //HTTP Version Fixed by @A18 08-04-2023
